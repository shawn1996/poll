...
class QuestionMethodTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() should return False for qeustions whose pub_date is in the future. """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() shold return True for questions whose pub_date is within the last day.
        """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date on the past should be displayed on the index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date in the past hshould display the question's text
        """
